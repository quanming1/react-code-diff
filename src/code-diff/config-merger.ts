...
export function colorsToCssVars(colors: ThemeColors): Record<string, string> {
  return {
    ...
    '--cd-token-symbol': colors.tokens.symbol,
    '--cd-token-tag': colors.tokens.tag,
    '--cd-token-boolean': colors.tokens.boolean,
    '--cd-token-number': colors.tokens.number,
    '--cd-token-string': colors.tokens.string,
    '--cd-token-char': colors.tokens.char,
    '--cd-token-attr-value': colors.tokens.attrValue,
    '--cd-token-keyword': colors.tokens.keyword,
    '--cd-token-operator': colors.tokens.operator,
    '--cd-token-function': colors.tokens.function,
    '--cd-token-method': colors.tokens.method,
    '--cd-token-class-name': colors.tokens.className,
    '--cd-token-builtin': colors.tokens.builtin,
    '--cd-token-variable': colors.tokens.variable,
    '--cd-token-constant': colors.tokens.constant,
    '--cd-token-regex': colors.tokens.regex,
    '--cd-token-important': colors.tokens.important,
    '--cd-token-attr-name': colors.tokens.attrName,
    '--cd-token-selector': colors.tokens.selector,
    '--cd-token-entity': colors.tokens.entity,
    '--cd-token-decorator': colors.tokens.decorator,
    '--cd-token-annotation': colors.tokens.annotation,
    '--cd-token-namespace': colors.tokens.namespace,
    '--cd-token-generic': colors.tokens.generic,
    '--cd-token-module': colors.tokens.module,
    '--cd-token-maybe-class-name': colors.tokens.maybeClassName,
    '--cd-token-parameter': colors.tokens.parameter,
    '--cd-token-interpolation': colors.tokens.interpolation,
    '--cd-token-interpolation-punctuation': colors.tokens.interpolationPunctuation,
    '--cd-token-property-access': colors.tokens.propertyAccess,
    '--cd-token-script-punctuation': colors.tokens.scriptPunctuation,
    '--cd-token-script': colors.tokens.script,
  }
}
